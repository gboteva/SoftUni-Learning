...
public class CommandInterpreterImpl implements CommandInterpreter {
    private final static String COMMAND_PACKAGE_NAME =
...
//        }
    ...
    private String parseCommandToClassName (String commandName){
       ...
       String otherLetters = commandName.substring(1);

       return COMMAND_PACKAGE_NAME + firstLetterUpperCase + otherLetters + "Command";
