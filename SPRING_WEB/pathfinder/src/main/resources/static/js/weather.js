...
fetch("http://api.openweathermap.org/data/2.5/weather?q=Pleven&APPID=0cf621284edfc862beca44d984562bef")
    .then(data => data.json())
    .then(info => {
...
fetch("http://api.openweathermap.org/data/2.5/weather?q=Varna, BGi&APPID=0cf621284edfc862beca44d984562bef")
    .then(data => data.json())
    .then(info => {
        //Formula Kelvin to Celsius 299K − 273.15 = 25.85°C
